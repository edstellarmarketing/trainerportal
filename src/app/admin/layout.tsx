...
const navItems = [
  ...
  { label: "Enquiries", href: "/admin/enquiries", icon: "M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
];
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="sm:hidden fixed top-0 left-0 right-0 bg-gray-900 text-white px-4 py-3 flex items-center justify-between z-10">
        ...
        <div className="flex gap-3">
          ...
          <Link href="/admin/enquiries" className="text-xs text-gray-300 hover:text-white">Enquiries</Link>
